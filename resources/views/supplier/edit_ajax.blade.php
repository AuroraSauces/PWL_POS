    ...
    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>Alamat</label>
                    <textarea name="supplier_alamat" id="supplier_alamat" class="form-control" rows="3">{{ $supplier->supplier_alamat }}</textarea>
                    <small id="error-supplier_alamat" class="error-text form-text text-danger"></small>
                </div>
                <!-- Kontak -->
                <div class="form-group">
                    <label>Kontak</label>
                    <input value="{{ $supplier->supplier_kontak }}" type="text" name="supplier_kontak" id="supplier_kontak" class="form-control">
