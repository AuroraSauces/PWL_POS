...
Route::group(['prefix' => 'level'], function () {
    ...
    Route::post('/', [LevelController::class, 'store'])->name('level.store'); // fallback store jika diperlukan
...
Route::group(['prefix' => 'supplier'], function () {
    ...
    Route::get('/{id}/show_ajax', [SupplierController::class, 'show_ajax'])->name('supplier.show_ajax'); // jika dibutuhkan
});
